  ...
  routes: [
    ...
    },
    {
      ...
      meta: {
        requiresAuth: false,
        seo: {
          title: 'Account Settings - PinPotha',
          description: 'Manage your PinPotha account and data preferences.',
          keywords: 'pinpotha account settings, delete account, privacy settings'
        }
      }
    },
    {
      ...
      meta: {
        requiresAuth: false,
        seo: {
          title: 'Privacy Policy - PinPotha',
          description: 'Read the PinPotha privacy policy and learn how your data is handled.',
          keywords: 'pinpotha privacy policy, data privacy, personal data'
        }
      }
    }
  ]
