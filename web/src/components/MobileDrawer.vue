      ...
      >
        ...
        <nav class="py-4">
          ...
          <button
            ...
            class="w-full px-4 py-3 flex items-center gap-3 text-left hover:bg-brand-accent/5 transition-colors"
            :class="{ 'bg-brand-accent/10 text-brand-accent': $route.path === '/account' }"
          >
            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-2.21 0-4 1.79-4 4m8 0a4 4 0 11-8 0m8 0v1a3 3 0 003 3h1m-4-7V8a3 3 0 10-6 0v1m10 3a8 8 0 11-16 0 8 8 0 0116 0z" />
            </svg>
